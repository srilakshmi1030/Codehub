...
public class AdvancedSearch {
	...
	{
		WebElement Search = driver.findElement(By.xpath("//select[@data-qaid='btn-search']"));
		Search.click();
	}
	...
	{
		WebElement Titletext = driver.findElement(By.xpath("//h1[@data-cmp='heading']//h1[@innerText='Certified BMW Convertibles for Sale in Alpharetta, GA']"));
				
		if (Titletext.getAttribute(title).equals(Titletext))
		{
		System.out.println(Titletext);
		}else
		{
			System.out.println("Failed to search "+ Titletext);
		}
	}
	
	public void resultcount()
	{
		WebElement searchresult1 = driver.findElement(By.xpath("//div[@class='results-text-container text-size-200']"));
		System.out.println(searchresult1.getText());
		
	}
	
	public void searchlink(String sampletext)
	{
		//String Searchresult = driver.findElement(By.xpath("//h2[@data-cmp='subheading']")).getText();
			//findElement(By.linkText("//h2[@data-cmp='subheading']"));

		 String url="";
	      List<WebElement> allURLs = driver.findElements(By.tagName("h2"));
	      System.out.println("Total links on the Wb Page: " + allURLs.size());
	      driver.findElement(By.partialLinkText(sampletext)).getText();
